...
plt.xlabel("Genre")
ax.bar(x-w, y, width=w, align='center', label=tid + " (" + str(tid) + ")")
ax.bar(x, y1, width=w, align='center', label=a1 + " (" + str(a1) + ") - delta: " + str(d1))
ax.bar(x+w, y2, width=w, align='center', label=a2 + " (" +str(a2)+ ") - delta: " + str(d2))
